...
{
    public sealed partial class BlutoothUI : UserControl
    {
        ...
        private void EnumerateBtn_Click(object sender, RoutedEventArgs e)
        {
            if (deviceWatcher == null)
            {
                StartBleDeviceWatcher();
                EnumerateBtn.Content = "Stop";
